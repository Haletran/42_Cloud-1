...
build:
	@cd src && ansible-playbook playbook/setup_hosts.yml --ask-vault-pass && ansible-playbook playbook/install_docker.yml  && ansible-playbook playbook/install_container.yml
